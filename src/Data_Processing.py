...
class DataProcessor():
    ...
    def loop_directory(self, folder: str, error_type_folder: str, type: str):
        '''
        ...
        error__type_folder (str): error code number (0-9) accessed as subdirectory
        ...
        for filename in os.listdir(folder+error_type_folder):
            if filename.startswith(type):
                file_directory = os.path.join(folder+error_type_folder, filename)
